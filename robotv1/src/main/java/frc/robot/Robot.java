...
import frc.robot.commands.auto.TestTurns;
...
public class Robot extends TimedRobot {
  ...
  public void disabledInit() {
    ...
    RobotContainer.autoChooser.setDefaultOption("Drive Distance", "Drive Distance");
    RobotContainer.autoMode.put("Drive Distance", new DriveDistance());
    addAutoToSelector(RobotContainer.autoChooser, "Turns Commands", new TestTurns());
